...
void UVMClass::getField(u1 *fieldOffest,UVMField *field,UCSYValue *operandStack,int &topOfOperandStack)
{
     ...
     switch( field->internalType )
     {
             ...
             case TYPE_BYTE:
                  operandStack[++topOfOperandStack].intValue = *(int8_t*) offest;
             break;
             case TYPE_SHORT:
                  operandStack[++topOfOperandStack].intValue = *(int16_t*)offest;
             break;
             
             case TYPE_INTEGER:
                  operandStack[++topOfOperandStack].intValue = *(int32_t*)offest;
             break;
...
void UVMClass::putField(u1 *fieldOffest,UVMField *field,UCSYValue *operandStack,int &topOfStack)
{
     ...
     switch( field->internalType )
     {
             ...
             case TYPE_BYTE:
                  *(int8_t*) offest=(int8_t) operandStack[topOfStack--].intValue;
             break;
             
             case TYPE_SHORT:
                  *(int16_t*)offest = operandStack[topOfStack--].intValue;
             break;
             
             case TYPE_INTEGER:
//                  cout<<"STORING "<<operandStack[topOfStack].intValue<<endl;
                  *(int32_t*)offest = operandStack[topOfStack--].intValue;
             break;
...
void UVMClass::putField(UVMObject *object,UVMField *field,UCSYValue *operandStack,int &topOfStack)
{
    ...
    // cout<<"Object New  put  top "<<topOfStack<<endl;
     ...
     switch( field->internalType )
     {
             ...
             case TYPE_BYTE:
                  integerData=(int8_t) operandStack[topOfStack--].intValue;
